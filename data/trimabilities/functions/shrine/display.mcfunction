...
execute as @e[type=chest_minecart,tag=trimShrine] if entity @s[nbt=!{Items:[{Slot:2b}]}] run item replace entity @s container.2 with minecraft:gray_stained_glass_pane[custom_name=[{"text":" ","italic":false}],custom_data={shrineDisplay:1b},tooltip_display={hidden_components:[attribute_modifiers,can_break,can_place_on,enchantments,unbreakable]}]
...
execute as @e[type=chest_minecart,tag=trimShrine] if entity @s[nbt=!{Items:[{Slot:6b}]}] run item replace entity @s container.6 with minecraft:gray_stained_glass_pane[custom_name=[{"text":" ","italic":false}],custom_data={shrineDisplay:1b},tooltip_display={hidden_components:[attribute_modifiers,can_break,can_place_on,enchantments,unbreakable]}]
...
execute as @e[type=chest_minecart,tag=trimShrine] if entity @s[nbt=!{Items:[{Slot:20b}]}] run item replace entity @s container.20 with minecraft:gray_stained_glass_pane[custom_name=[{"text":" ","italic":false}],custom_data={shrineDisplay:1b},tooltip_display={hidden_components:[attribute_modifiers,can_break,can_place_on,enchantments,unbreakable]}]
...
execute as @e[type=chest_minecart,tag=trimShrine] if entity @s[nbt=!{Items:[{Slot:24b}]}] run item replace entity @s container.24 with minecraft:gray_stained_glass_pane[custom_name=[{"text":" ","italic":false}],custom_data={shrineDisplay:1b},tooltip_display={hidden_components:[attribute_modifiers,can_break,can_place_on,enchantments,unbreakable]}]
...
clear @a minecraft:gray_stained_glass_pane[custom_name=[{"text":" ","italic":false}],custom_data={shrineDisplay:1b},tooltip_display={hidden_components:[attribute_modifiers,can_break,can_place_on,enchantments,unbreakable]}]

execute as @a store success score @s buttonRecovery run clear @a chest_minecart[custom_data={trimShrine:1b}]
