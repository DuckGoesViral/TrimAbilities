...
execute as @a[tag=ward,scores={mcLvl=5..,tLvl=3..}] run effect give @s slowness infinite 0 true
execute as @a[tag=ward,scores={mcLvl=5..,tLvl=3..}] run effect give @s resistance infinite 0 true
