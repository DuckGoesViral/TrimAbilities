...
tellraw @a[=3] {"text": "Reload Succesful!","color": "#0000FF","bold": true}
...
scoreboard objectives add level3s dummy
scoreboard objectives add level4s dummy
scoreboard objectives add level5s dummy
