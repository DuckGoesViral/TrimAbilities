...
execute as @a[tag=snout,scores={wLvl=..4}] run attribute @s generic.max_health base set 16
execute as @a[tag=snout,scores={wLvl=5..}] run attribute @s generic.max_health base set 18
execute as @a[tag=snout] run effect give @s strength infinite 1 true
execute as @a[tag=snout] run effect give @s speed infinite 0 true
