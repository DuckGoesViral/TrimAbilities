...
execute as @e[type=arrow,tag=wayfinderarrowpo0] run data merge entity @s {damage:3d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpo1] run data merge entity @s {damage:4d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpo2] run data merge entity @s {damage:4.5d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpo3] run data merge entity @s {damage:5d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpo4] run data merge entity @s {damage:5.5d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpo5] run data merge entity @s {damage:6d,PierceLevel:1b}

execute as @e[type=arrow,tag=wayfinderarrowpi0] run data merge entity @s {damage:3d,PierceLevel:1b}
execute as @e[type=arrow,tag=wayfinderarrowpi1] run data merge entity @s {damage:3d,PierceLevel:2b}
execute as @e[type=arrow,tag=wayfinderarrowpi2] run data merge entity @s {damage:3d,PierceLevel:3b}
execute as @e[type=arrow,tag=wayfinderarrowpi3] run data merge entity @s {damage:3d,PierceLevel:4b}
execute as @e[type=arrow,tag=wayfinderarrowpi4] run data merge entity @s {damage:3d,PierceLevel:5b}
