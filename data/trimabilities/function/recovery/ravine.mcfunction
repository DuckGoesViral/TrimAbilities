...
execute at @s as @e[type=item,nbt={Item:{tag:{Trim:{pattern:"trimabilities:ravine"}}}},distance=..10,limit=1,sort=nearest] run data merge entity @s {Item:{tag:{Trim:{pattern:""}}}}
