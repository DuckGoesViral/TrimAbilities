...
execute if score @s dune matches 3 run effect give @s speed infinite 1 true
...
execute if score @s dune matches 4 run effect give @s speed infinite 1 true
...
execute if score @s dune matches 4 if score @s sneakTrigger matches 2.. if score @s cooldownDuneDisplay matches ..0 run effect give @s speed 12 2 true
