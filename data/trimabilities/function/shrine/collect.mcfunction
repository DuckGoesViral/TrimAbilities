...
execute if score @s recoveryBolt matches 1.. run return run function trimabilities:shrine/collect/bolt
execute if score @s recoveryFlow matches 1.. run return run function trimabilities:shrine/collect/flow
