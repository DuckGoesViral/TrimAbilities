...
execute unless score @s mana matches 35.. run return run tellraw @s ["",{"text":"Not enough Mana to cast Ice Cube!","color":"red","bold": true}]
...
execute as @e[tag=frozen] run effect give @s resistance 3 5 true
