execute unless score @s mana matches 35.. at @s run playsound minecraft:entity.enderman.teleport ambient @s ~ ~ ~
execute unless score @s mana matches 35.. run return run tellraw @s ["",{"text":"Not enough Mana to cast Fireball!","color":"red","bold": true}]
...
summon marker ~ ~3 ~ {Tags:["blackhole"]}
tag @s add holeblack


execute at @s run particle minecraft:reverse_portal ~ ~1 ~ 0 0 0 1 35 normal @a[distance=..25]
