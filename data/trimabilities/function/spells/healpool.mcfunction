...
execute at @s run summon item_display ~ ~.5 ~ {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"totem_of_undying",Count:1b},Tags:["healPool","newSummon"]}
# Team-agnostic: the pool joins the caster's team (whatever team that is).
