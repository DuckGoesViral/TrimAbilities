...
execute as @a[scores={team_aqua=1..}] store success score @s registration_check run data modify storage teams:macro this.Name set from entity 3ecf96f6-5342-4ab1-a629-10926cea8230 item.tag.SkullOwner.Name
