...
execute as @a[scores={registered=0}] store success score @s registration_check run data modify storage teams:macro this.Name set from entity 3ecf96f6-5342-4ab1-a629-10926cea8230 item.tag.SkullOwner.Name
execute as @a[scores={registered=0}] if score @s registration_check matches 1.. run scoreboard players set @s registered 1