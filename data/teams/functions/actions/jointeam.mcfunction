...
execute as @a[scores={join_aqua=1..},team=!AquaTeam] if score aqua_team aqua_team_count matches 0 run team leave @s
execute as @a[scores={join_aqua=1..},team=!AquaTeam] if score aqua_team aqua_team_count matches 0 run team join AquaTeam @s
...
execute as @a[scores={join_gold=1..},team=!GoldTeam] if score gold_team gold_team_count matches 0 run team leave @s
execute as @a[scores={join_gold=1..},team=!GoldTeam] if score gold_team gold_team_count matches 0 run team join GoldTeam @s
...
execute as @a[scores={join_blue=1..},team=!BlueTeam] if score blue_team blue_team_count matches 0 run team leave @s
execute as @a[scores={join_blue=1..},team=!BlueTeam] if score blue_team blue_team_count matches 0 run team join BlueTeam @s
...
execute as @a[scores={join_gray=1..},team=!GrayTeam] if score gray_team gray_team_count matches 0 run team leave @s
execute as @a[scores={join_gray=1..},team=!GrayTeam] if score gray_team gray_team_count matches 0 run team join GrayTeam @s
...
execute as @a[scores={join_green=1..},team=!GreenTeam] if score green_team green_team_count matches 0 run team leave @s
execute as @a[scores={join_green=1..},team=!GreenTeam] if score green_team green_team_count matches 0 run team join GreenTeam @s
...
execute as @a[scores={join_red=1..},team=!RedTeam] if score red_team red_team_count matches 0 run team leave @s
execute as @a[scores={join_red=1..},team=!RedTeam] if score red_team red_team_count matches 0 run team join RedTeam @s
...
execute as @a[scores={join_purple=1..},team=!PurpleTeam] if score purple_team purple_team_count matches 0 run team leave @s
execute as @a[scores={join_purple=1..},team=!PurpleTeam] if score purple_team purple_team_count matches 0 run team join PurpleTeam @s
...
execute as @a[scores={join_yellow=1..},team=!YellowTeam] if score yellow_team yellow_team_count matches 0 run team leave @s
execute as @a[scores={join_yellow=1..},team=!YellowTeam] if score yellow_team yellow_team_count matches 0 run team join YellowTeam @s
...
scoreboard players enable @a join_aqua 
scoreboard players enable @a join_gold 
scoreboard players enable @a join_blue 
scoreboard players enable @a join_gray 
scoreboard players enable @a join_green 
scoreboard players enable @a join_red 
scoreboard players enable @a join_purple 
